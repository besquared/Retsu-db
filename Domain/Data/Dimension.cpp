...
Retsu::Domain::Data::Dimension::Dimension(const string& path, const string& name) {
  this->path = path;
  this->name = name;
  this->database = tchdbnew();
}

Retsu::Domain::Data::Dimension::~Dimension() {
  this->Close();
...
std::string Retsu::Domain::Data::Dimension::Path() {
  return this->path + "/" + this->name + ".tch";
}

bool Retsu::Domain::Data::Dimension::Create() {
...
bool Retsu::Domain::Data::Dimension::Truncate() {
...
bool Retsu::Domain::Data::Dimension::Close() {	
...
bool Retsu::Domain::Data::Dimension::Optimize() {
...
bool Retsu::Domain::Data::Dimension::OpenReader() {
  return this->Open(HDBOREADER);
}

bool Retsu::Domain::Data::Dimension::OpenWriter() {
  return this->Open(HDBOWRITER | HDBOCREAT);
}

bool Retsu::Domain::Data::Dimension::Open(int mode) {
...
void Retsu::Domain::Data::Dimension::Lookup(const RecordID key, string& result) {
	int vsize;
...
void Retsu::Domain::Data::Dimension::Lookup(const RIDList& keys, vector<string>& results) {
...
void Retsu::Domain::Data::Dimension::Lookup(const RIDList& keys, map<RecordID, string>& results) {
	int written = 0;
	int bsize = 4096;
	void* buffer = malloc(bsize * sizeof(char));
...
bool Retsu::Domain::Data::Dimension::Insert(const RecordID key, const string& value) {
...
std::string Retsu::Domain::Data::Dimension::Error() {
